...
StorageClient.prototype.attach = function(_super) {
    ...
    this.notificationCenter.addObserver("Storage", "UserDiskChange", function(disk) {
        self.event.trigger("storage.notification#userdiskchange", disk);
    });
...
StorageClient.prototype.detach = function() {
    ...
    this.notificationCenter.removeObserver("Storage", "UserDiskChange");
