...
function onStorageWorkingDiskChange(disk) {
    NotificationController.add(
...
function onStorageWorkingDiskSet(disk) {
    /*
    NotificationController.add(
        "Working disk set",
...
module.exports = {
    register: function() {
        ...
        StorageClient.on("storage.notification#workingdiskchange", onStorageWorkingDiskChange);
        StorageClient.on("storage.notification#workingdiskset", onStorageWorkingDiskSet);
    ...
    unregister: function() {
        ...
        StorageClient.removeListener("storage.notification#workingdiskchange", onStorageWorkingDiskChange);
        StorageClient.removeListener("storage.notification#workingdiskset", onStorageWorkingDiskSet);
