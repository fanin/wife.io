...
var DiligentClient = assign({}, EventEmitter.prototype, {
    ...
    init: function() {
        this.notificationCenter = require('./notification-center');
        this.storageManager     = require('./storage-manager');
        this.appManager         = require('./app-manager');
        this.extensionManager   = require('./extension-manager');
        this.fileManager        = require('./file-manager');

        this.loadWSwsapi(function(error) {
            if (!error) {
                /**
                 * Diligent Client Startup Procedure
                ...
                /**
                 * Diligent Client Startup Procedure
                 * #4: Server returns manifest to describe the running app
                 */
