...
var cbq          = require('utils/callback-queue');
var generateUID  = require('utils/string-code').generateUID;
...
var AppManager = assign({}, EventEmitter.prototype, {
    ...
    attach: function(_super) {
        ...
        this.socket.on(this.wsapi.Install.RES, function(status, instid, manifest) {
