...
TableView.prototype.show = function() {
    ...
    if (self.lock) {
        return setTimeout(function() { self.show(); }, 200);
    }
...
TableView.prototype.reloadRowAtIndex = function(index, complete) {
    ...
    if (self.lock) {
        return setTimeout(function() { self.reloadRowAtIndex(index, complete); }, 200);
    }
...
TableView.prototype.selectRowAtIndex = function(index) {
    ...
    if (rowContainer && !rowContainer.hasClass("selected")) {
...
TableView.prototype.insertRowAtIndex = function(index, complete) {
    ...
    if (self.lock) {
        return setTimeout(function() { self.insertRowAtIndex(index, complete); }, 200);
    }
...
TableView.prototype.removeRowAtIndex = function(index, complete) {
    ...
    if (self.lock) {
        return setTimeout(function() { self.removeRowAtIndex(index, complete); }, 200);
    }
    ...
    var rowContainer = self.view.find("ul").find("li").eq(index);
    rowContainer && rowContainer.remove();
