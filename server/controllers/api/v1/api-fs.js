...
var express    = require('express'),
    ...
    fsmgr      = require('system/fs/fs-manager');
 ...
 *
 * @apiReturn 200 {Object} stat File status object. See Node.js _[fs.Stats Class](https://nodejs.org/api/fs.html#fs_class_fs_stats)_ for details.
 * @apiReturn 404 File not found.
 ...
 * @apiParam  {String}  path           URL encoded path.
 * @apiParam  {String}  pattern        Regular expression pattern. See _[JavaScript RegExp Reference](http://www.w3schools.com/jsref/jsref_obj_regexp.asp)_ for details.
 * @apiOption {String}  disk_uuid      Specify the disk for resolving the given `:path`. *Default: Internal data disk.*
 ...
 * @apiOption {String}  regex_modifier Modifiers are used to perform case-insensitive and global searches. See _[JavaScript RegExp Reference](http://www.w3schools.com/jsref/jsref_obj_regexp.asp)_ for details.
