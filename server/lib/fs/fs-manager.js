...
module.exports = {
  ...
  grep: function(_path, pattern, option, callback) {
    ...
    option.matchOnly = typeof option.matchOnly === 'boolean'
                        ? option.matchOnly
                        : defaultOption.matchOnly;
    option.testOnly = typeof option.testOnly === 'boolean'
                        ? option.testOnly
                        : defaultOption.testOnly;
    option.parseFormat = typeof option.parseFormat === 'boolean'
                        ? option.parseFormat
                        : defaultOption.parseFormat;
