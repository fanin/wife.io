/**
 * The **App Management Web API** allows user to manage apps in the system. This is only available for internal apps which are authorized for app management such as `Launcher` and `AppShop`.
 *
 ...
 *
 * @apiMethod GetAppByID {GET} /app/`:appid`
 ...
 *
 * @apiMethod Install {POST} /app/install
 * @apiReqBody {Object} formdata `FormData` object built with `File` object of app package.
 *
 ...
 *
 * @apiMethod GetInstallStatus {GET} /app/install/`:instid`
 ...
 * Uninstall app by ID.
 *
 * @apiMethod Uninstall {DELETE} /app/`:appid`
 * @apiParam {String} appid App identifier.
 *
