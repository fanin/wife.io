export default class LauncherAppIcon extends React.Component {
  ...
  componentDidMount() {
    ...
    document.getElementById(
      'launcher-icon-img-' + this.props.manifest.identifier
    ).draggable = false;

    document.getElementById(
      'launcher-icon-text-' + this.props.manifest.identifier
    ).draggable = false;
  }

  render() {
    var iconAHref = '/apps/' + this.props.appType
                       + '/' + this.props.manifest.directory
                       + '/' + this.props.manifest.entry;

    var iconDivStyle = (this.props.appType === 'ua')
      ? { backgroundImage:
            'url(/apps/u/' + this.props.manifest.directory + '/img/icon.png)'
    ...
    var iconImgSrc =
      '/apps/' + this.props.appType + '/'
               + this.props.manifest.directory + '/img/icon.png';

    return (
      <li
        key={this.props.manifest.identifier}
      ...
      >
        <div className={this.props.manageable ? 'shake-app' : ''}>
          <a
            ...
            title={(this.props.manageable && this.props.appType === 'ua')
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  display: (this.props.appType === 'ua' && this.props.manageable)
                            ? 'block' : 'none'
                }}
              >
                <img
