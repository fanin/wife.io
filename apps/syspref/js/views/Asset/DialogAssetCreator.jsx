...
export class AssetCreatorForm extends React.Component {
    ...
    return (
      ...
      >
        <div className="two fields">
          <div className="field">
            <label>ID</label>
            <Input type="text" name="assetid" defaultValue={this.props.assetid} />
          </div>
          <div className="field">
            <label>Name</label>
        ...
        <div className="two fields">
          <div className="field">
            <label>Vendor</label>
            <Input type="text" name="vendor" defaultValue={this.props.vendor} />
          </div>
          <div className="field">
            <label>Model</label>
            <Input type="text" name="model" defaultValue={this.props.model} />
          </div>
        </div>
        <div className="two fields">
          <div className="field">
            <label>Serial</label>
            <Input type="text" name="serial" defaultValue={this.props.serial} />
          </div>
          <div className="field">
            <label>Owner</label>
            <Dropdown
        ...
        <div className="two fields">
          <div className="field">
            ...
            <Input type="text" name="acquisition_date" defaultValue={this.props.acquisition_date} />
          </div>
          <div className="field">
            <label>Warranty Expiration Date</label>
            <Input type="text" name="warranty_expiration_date" defaultValue={this.props.warranty_expiration_date} />
          </div>
        </div>
        <div className="field">
...
export default class DialogAssetCreator extends React.Component {
  ...
  show(defaultValues) {
    if (defaultValues) this.setState(defaultValues);
