...
(function() {
  ...
  ElementsRenderer = (function() {
    function ElementsRenderer(tree_widget) {
      ...
      this.folder_icon_element = this.createButtonElement(tree_widget.options.folderIcon);
      this.node_icon_element = this.createButtonElement(tree_widget.options.nodeIcon);
    }
    ...
    ElementsRenderer.prototype.createFolderLi = function(node) {
      ...
      if (this.folder_icon_element) {
        button_link.appendChild(document.createTextNode(' '));
        button_link.appendChild(this.folder_icon_element.cloneNode());
      }
    ...
    ElementsRenderer.prototype.createNodeLi = function(node) {
      var button_classes, class_string, div, button_link, escaped_name, li, li_classes, title_span;
      button_classes = this.getButtonClasses(node);
      ...
      div.className = "jqtree-element jqtree_common";
      li.appendChild(div);
      if (this.node_icon_element) {
        button_link = document.createElement('a');
        button_link.className = "jqtree_common " + button_classes;
        button_link.appendChild(this.node_icon_element.cloneNode());
        div.appendChild(button_link);
      }
      title_span = document.createElement('span');
  ...
  FolderElement = (function(_super) {
    ...
    FolderElement.prototype.open = function(on_finished, slide) {
      ...
      if (!this.node.is_open) {
        ...
        $button.append(' ');
        $button.append(this.tree_widget.renderer.folder_icon_element.cloneNode());
  ...
  GhostDropHint = (function() {
    function GhostDropHint(node, $element, position) {
      ...
      this.node = node;
      this.$ghost = $('<li class="jqtree_common jqtree-ghost"><span class="jqtree_common"></span><span class="jqtree_common jqtree-line"></span></li>');
      if (position === Position.AFTER) {
        this.moveAfter();
      } else if (position === Position.BEFORE) {
        this.moveBefore();
